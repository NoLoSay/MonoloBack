...
import {
  ...
  CreateAdminProfileRequestBody,
  CreateManagerProfileRequestBody,
  CreateModeratorProfileRequestBody,
  DeleteAdminProfileRequestBody,
  DeleteManagerProfileRequestBody,
  DeleteModeratorProfileRequestBody,
...
export class ProfileController {
  ...
  async createManagerProfile(
    ...
    return res
      .status(200)
      .json(
        await this.profileService.createProfile(whoPromote.userId, MANAGER),
      );
  }
